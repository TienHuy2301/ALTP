...
//-----[ Tạo giao diện ]--------//
    ...
    private void addItem() {
        ...
        p_login.add(new JLabel("Tên Đăng Nhập: "));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == exit) {
            ...
            if (checkLogin(nick1.getText())) {
                ...
                dataStream = new Data(this, this.dis);
            } else {
                JOptionPane.showMessageDialog(this, "Đã tồn tại nick này trong máy chủ, bạn vui lòng nhập lại.", "Message Dialog", JOptionPane.WARNING_MESSAGE);
            }
